 ...
 */
public class FavouriteTransportAdapter extends RecyclerView.Adapter<FavouriteTransportAdapter.ViewHolder> {
    private Context ctx;
    private List<Transport> buses;

    public FavouriteTransportAdapter(Context context, List<Transport> buses) {
        this.ctx = context;
        this.buses = buses;
    }
